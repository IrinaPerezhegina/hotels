...
function guessNumber(){
 let computerOne
 console.log('Один игрок загадывает целое число от 1 до 100, другой игрок отгадывает результат');
 ...
 while (middle!==computerOne) {
   ...
   console.log("Копьютер 2: Число в диапазоне от " + start +" до "+ end +". "+"Пробую число"+" "+ middle+".");
